                  ...
                  <tbody>
                    ...
                    <tr class="actions">
                      <td class="border-0" colspan="6">
                        <button type="submit" class="update-cart" disabled>Cập nhật</button>
                        <button type="submit" class="clear-cart">Dọn dẹp giỏ hàng</button>
                        <a href="shop.html" class="btn-theme btn-flat">Tiếp tục mua hàng</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <div class="row row-gutter-50">
          ...
          <div class="col-md-12 col-lg-4">
            <div class="shipping-form-cart-totals">
              ...
              <a class="btn-theme btn-flat" href="index.php?act=CTthanhtoan">Proceed to checkout</a>
            </div>
          </div>
        </div>
      </div>
