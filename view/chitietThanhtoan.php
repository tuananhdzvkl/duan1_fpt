<main class="main-content">
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-header-content">
              <h2 class="title" data-aos="fade-down" data-aos-duration="1000">Thủ tục thanh toán</h2>
    ...
    <!--== Start Shopping Thủ tục thanh toán Area Wrapper ==-->
    <section class="shopping-Thủ tục thanh toán-wrap">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="Thủ tục thanh toán-page-login-wrap">
              <!--== Start Thủ tục thanh toán Login Accordion ==-->
              <div class="login-accordion" id="LoginAccordion">
                <div class="card">
                  <h3>
                    <i class="fa fa-info-circle"></i>
                   PHản hồi khách hàng
                    <a href="#/" data-bs-toggle="collapse" data-bs-target="#loginaccordion">Nhấn vào đây để đăng nhập</a>
                  </h3>
                  <div id="loginaccordion" class="collapse" data-bs-parent="#LoginAccordion">
                    <div class="card-body">
                      <div class="login-wrap">
                        <p>
Nếu bạn đã mua hàng với chúng tôi trước đây, vui lòng nhập thông tin chi tiết của bạn bên dưới. Nếu bạn là khách hàng mới, vui lòng chuyển sang phần Thanh toán & Vận chuyển.</p>
                        <form action="#" method="post">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="logEmail">Tên hoặc email <span class="required">*</span></label>
                              ...
                              <div class="form-group mt-30">
                                ...
                                <div class="rememberme-account">
                                  <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="remembermePass">Ghi nhớ lần sau</label>
                                  </div>
                                </div>
              ...
              <!--== End Thủ tục thanh toán Login Accordion ==-->
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="Thủ tục thanh toán-page-coupon-wrap">
              <!--== Start Thủ tục thanh toán Coupon Accordion ==-->
                      ...
                      <div class="apply-coupon-wrap mb-60">
                        ...
                        <form action="#" method="post">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <button class="btn-coupon">Xác nhận mã giảm giá</button>
                            </div>
                          </div>
                        </form>
                      </div>
              ...
              <!--== End Thủ tục thanh toán Coupon Accordion ==-->
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="Thủ tục thanh toán-billing-details-wrap">
              ...
              <div class="billing-form-wrap">
                <form action="#" method="post">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="l_name">Họ <abbr class="required" title="required">*</abbr></label>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="country">Quốc gia <abbr class="required" title="required">*</abbr></label>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="street-address">Địa chỉ đường <abbr class="required" title="required">*</abbr></label>
                        <input id="street-address" type="text"  class="form-control" placeholder="House number and street name">
                      </div>
                      <div class="form-group">
                        <label for="street-address2" class="visually-hidden">Địa chỉ đường 2<abbr class="required" title="required">*</abbr></label>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="pz-code">Mã bưu điện/ZIP (tùy chọn)</label>
                        <input id="pz-code" type="text"  class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="phone">Số điện thoại(tự chọn)</label>
                        <input id="phone" type="text"  class="form-control">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group" data-margin-bottom="30">
                        <label for="email">Địa chi email <abbr class="required" title="required">*</abbr></label>
                        <input id="email" type="text"  class="form-control">
                      </div>
                    </div>
                    <div id="Thủ tục thanh toánBillingAccordion" class="col-md-12">
                      <div class="Thủ tục thanh toán-box" data-margin-bottom="25" data-bs-toggle="collapse" data-bs-target="#Thủ tục thanh toánOne" aria-expanded="false" role="toolbar">
                        <div class="custom-control custom-checkbox">
                      ...
                      <div id="Thủ tục thanh toánOne" class="collapse" data-margin-top="30" data-bs-parent="#Thủ tục thanh toánBillingAccordion">
                        <div class="form-group">
                          <label for="password">Tạo mật khẩu tài khoản <abbr class="required" title="required">*</abbr></label>
                          <input id="password" type="password"  class="form-control" placeholder="Password">
                        </div>
                      </div>
                    </div>
                    <div id="Thủ tục thanh toánBillingAccordion2" class="col-md-12">
                      <div class="Thủ tục thanh toán-box" data-margin-bottom="25" data-bs-toggle="collapse" data-bs-target="#Thủ tục thanh toánTwo" aria-expanded="false" role="toolbar">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input visually-hidden" id="ship-to-different-address">
                          <label class="custom-control-label" for="ship-to-different-address">Gửi đến một địa chỉ khác?</label>
                        </div>
                      </div>
                      <div id="Thủ tục thanh toánTwo" class="collapse" data-margin-top="30"  data-bs-parent="#Thủ tục thanh toánBillingAccordion2">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="f_name2">Tên <abbr class="required" title="required">*</abbr></label>
                              <input id="f_name2" type="text"  class="form-control">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="l_name2">Họ <abbr class="required" title="required">*</abbr></label>
                              <input id="l_name2" type="text"  class="form-control">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="com_name2">Tên công ty(nếu có)</label>
                              <input id="com_name2" type="text"  class="form-control">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="country2">Quốc gia <abbr class="required" title="required">*</abbr></label>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="street-address2-3">Địa chỉ đường <abbr class="required" title="required">*</abbr></label>
                              <input id="street-address2-3" type="text"  class="form-control" placeholder="House number and street name">
                            </div>
                            <div class="form-group">
                              <label for="street-address2-2" class="visually-hidden">Địa chỉ đường 2 <abbr class="required" title="required">*</abbr></label>
                              <input id="street-address2-2" type="text"  class="form-control" placeholder="Apartment, suite, unit etc. (optional)">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="town3">Thị trấn / Thành phố <abbr class="required" title="required">*</abbr></label>
                              <input id="town3" type="text"  class="form-control">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="district2">Huyện <abbr class="required" title="required">*</abbr></label>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="pz-code2">mã bưu điện / ZIP(Tùy chọn)</label>
          ...
          <div class="col-lg-6">
            ...
            <div class="Thủ tục thanh toán-order-details-wrap">
              <div class="order-details-table-wrap table-responsive">
                ...
                <div class="shop-payment-method">
                  <div id="PaymentMethodAccordion">
                    ...
                    <div class="card">
                      <div class="card-header" id="check_payments2">
                        <h5 class="title" data-bs-toggle="collapse" data-bs-target="#itemTwo" aria-controls="itemTwo" aria-expanded="false">Kiểm tra thanh toán</h5>
                      </div>
                    ...
                    <div class="card">
                      <div class="card-header" id="check_payments4">
                        <h5 class="title" data-bs-toggle="collapse" data-bs-target="#itemFour" aria-controls="itemTwo" aria-expanded="false">PayPal Express Thủ tục thanh toán <img src="assets/img/photos/paypal2.webp" width="40" height="26" alt="Image-HasTech"></h5>
                      </div>
                  ...
                  <p class="p-text">Dữ liệu cá nhân của bạn sẽ được sử dụng để xử lý đơn đặt hàng, hỗ trợ trải nghiệm của bạn trên trang web này và cho các mục đích khác được mô tả trong phần của chúng tôi.<a href="#/">Chính sách bảo mật.</a></p>
    ...
    <!--== End Shopping Thủ tục thanh toán Area Wrapper ==-->
  </main>