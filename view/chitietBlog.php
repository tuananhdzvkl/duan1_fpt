        ...
        <div class="row">
          <div class="col-12">
            <div class="page-header-content">
              <h2 class="title" data-aos="fade-down" data-aos-duration="1000">Chi tiết blog</h2>
          ...
          <div class="col-xl-8" data-aos="fade-right">
            <div class="blog-details-content-wrap">
              ...
              <div class="comment-view-area">
                <h4 class="title-main">Bình luận</h4>
              ...
              <div class="comment-form-area">
                <h4 class="title-main">Để lại 1 bình luận</h4>
            ...
            <div class="blog-sidebar">
              ...
              <div class="blog-sidebar-wrap">
                <div class="blog-sidebar-category">
                  <h4 class="sidebar-title" data-margin-bottom="23">Thể loại</h4>
                ...
                <div class="blog-sidebar-post">
                  <h4 class="sidebar-title">Bài đăng gần đây</h4>
                ...
                <div class="blog-sidebar-category-sub-menu">
                  <h4 class="sidebar-title" data-margin-bottom="23">Lưu trữ</h4>
