<main class="main-content">
    ...
    <!--== Start Danh sách yêu thích Area Wrapper ==-->
    <section class="shopping-Danh sách yêu thích-area">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="shopping-Danh sách yêu thích-table table-responsive">
              <table class="table text-center">
                ...
                <tbody>
                  <tr class="cart-Danh sách yêu thích-item">
    ...
    <!--== End Danh sách yêu thích Area Wrapper ==-->
  </main>