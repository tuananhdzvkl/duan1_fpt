<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addspbt">Thêm Mới <i class="bi bi-plus-circle"></i></button>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php foreach ($sanpham_bienthe as $key => $value) : ?>
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    <a href="?act=editsp&idsp=<?= $value['id_sp'] ?>" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editspbt"><i class="bi bi-pencil-square"></i> Sửa</a>
  ...
  <!-- Edit Variant Modal -->
<div class="modal" id="editspbt">
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-down" class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Sửa Biến Thể</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            ...
            <div class="modal-body">
                    <form action="?act=upsp" method="post">
                        ...
                        <div class="modal-footer">
                            <input type="submit" class="btn btn-primary" data-bs-dismiss="modal" name="bienthe" value="Cập Nhật">
                        </div>
                    </form>
                </div>
        </div>
